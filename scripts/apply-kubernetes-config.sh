...
kubectl apply -f /tmp/latest_artifact_web/k8s/openglotWeb-deployment.yaml --namespace openglot
kubectl apply -f /tmp/latest_artifact_web/k8s/openglotWeb-service.yaml --namespace openglot
